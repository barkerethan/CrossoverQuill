 ...
 * This file demonstrates how to integrate Crossoverquill with a web frontend
 */

// For React/Vue/Angular applications
export class CrossoverquillClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CrossoverquillClient(provider, contractAddress);
