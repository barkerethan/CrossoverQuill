...
const contractABI = require("../artifacts/contracts/Crossoverquill.sol/Crossoverquill.json").abi;

program
    .name("crossoverquill-cli")
    .description("CLI tool for Crossoverquill smart contract")
    .version("1.0.0");
